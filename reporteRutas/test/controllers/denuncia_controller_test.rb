...
class DenunciaControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create denuncium" do
    assert_difference('Denuncium.count') do
      post denuncia_url, params: { denuncium: { comentario: @denuncium.comentario, dni: @denuncium.dni, email: @denuncium.email, fecha: @denuncium.fecha, id_ruta: @denuncium.id_ruta, nombre: @denuncium.nombre, telefono: @denuncium.telefono } }
    end
  ...
  test "should update denuncium" do
    patch denuncium_url(@denuncium), params: { denuncium: { comentario: @denuncium.comentario, dni: @denuncium.dni, email: @denuncium.email, fecha: @denuncium.fecha, id_ruta: @denuncium.id_ruta, nombre: @denuncium.nombre, telefono: @denuncium.telefono } }
